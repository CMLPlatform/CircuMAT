...
import { get } from 'lodash';  // instead of import getPropValue from "rc-tree-select";
...
class FilterableMultiSelectDropdownTree extends Component {
    ...
    filterCaseInsensitive(inputValue, treeNode) {
        return String(get(treeNode, labelCompatible('label'))).toLowerCase().indexOf(inputValue.toLowerCase()) > -1;
    }
}
