"""
Django settings for circumatMasterProject project.
...
ASGI_APPLICATION = 'circumatMasterProject.routing.channel_routing'
...
ROOT_URLCONF = 'circumatMasterProject.urls'
...
WSGI_APPLICATION = 'circumatMasterProject.wsgi.application'
