...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3plus-color'), require('d3plus-common'), require('@popperjs/core/dist/esm/popper')) : typeof define === 'function' && define.amd ? define('d3plus-tooltip', ['exports', 'd3-selection', 'd3plus-color', 'd3plus-common', '@popperjs/core/dist/esm/popper'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Selection, global.d3plusColor, global.d3plusCommon, global.popper));
})(this, function (exports, d3Selection, d3plusColor, d3plusCommon, popper) {
  'use strict';
  /**
  ...
  */
  ...
  var Tooltip = /*#__PURE__*/function (_d3plusCommon$BaseCla) {
    _inherits(Tooltip, _d3plusCommon$BaseCla);
    ...
    */
    function Tooltip() {
      ...
      _this._background = d3plusCommon.constant(d3plusColor.colorDefaults.light);
      _this._body = d3plusCommon.accessor("body", "");
      _this._bodyStyle = {
        "color": d3plusColor.colorDefaults.dark,
      ...
      _this._padding = d3plusCommon.constant("10px");
      ...
      value: function render(callback) {
        ...
        */
        ...
        enter.attr("id", function (d, i) {
          ...
          _this2._popperClasses[id] = popper.createPopper(referenceObject, tooltip, {
            placement: "top",
