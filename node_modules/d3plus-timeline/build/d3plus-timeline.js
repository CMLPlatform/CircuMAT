...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-brush'), require('d3-scale'), require('d3-selection'), require('d3plus-axis'), require('d3plus-color'), require('d3plus-common'), require('d3plus-text')) : typeof define === 'function' && define.amd ? define('d3plus-timeline', ['exports', 'd3-array', 'd3-brush', 'd3-scale', 'd3-selection', 'd3plus-axis', 'd3plus-color', 'd3plus-common', 'd3plus-text'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Brush, global.d3Scale, global.d3Selection, global.d3plusAxis, global.d3plusColor, global.d3plusCommon, global.d3plusText));
})(this, function (exports, d3Array, d3Brush, d3Scale, d3Selection, d3plusAxis, d3plusColor, d3plusCommon, d3plusText) {
  'use strict';
  /**
      @external Axis
  ...
  */
  ...
  var Timeline = /*#__PURE__*/function (_d3plusAxis$Axis) {
    _inherits(Timeline, _d3plusAxis$Axis);
    ...
    */
    function Timeline() {
      ...
      _this._gridSize = 0;
      _this._handleConfig = {
        fill: d3plusColor.colorDefaults.dark
      };
      _this._handleSize = 6;
      _this._height = 100;
      ...
      _this._shapeConfig = Object.assign({}, _this._shapeConfig, {
        ...
        fill: function fill() {
          return _this._buttonBehaviorCurrent === "buttons" ? d3plusColor.colorDefaults.light : d3plusColor.colorDefaults.dark;
        },
    ...
    _createClass(Timeline, [{
      ...
      */
      ...
      value: function _updateDomain(event) {
        var x = d3Selection.pointer(event, this._select.node())[0];
