...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('html2canvas'), require('canvg-browser'), require('d3-selection'), require('canvas-toBlob'), require('file-saver')) : typeof define === 'function' && define.amd ? define('d3plus-export', ['exports', 'html2canvas', 'canvg-browser', 'd3-selection', 'canvas-toBlob', 'file-saver'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.html2canvas, global.canvg, global.d3Selection, null, global.fileSaver));
})(this, function (exports, html2canvas, canvg, d3Selection, canvasToBlob, fileSaver) {
  'use strict';
  ...
  function dom2canvas(elem, options) {
    ...
    function checkRender(trans) {
      ...
      if (!tag.length) {
        ...
        html2canvas__default['default'](this, {
          allowTaint: true,
          canvas: tempCanvas,
      ...
      for (var _i3 = 0; _i3 < layers.length; _i3++) {
        ...
        switch (layer.type) {
          ...
          case "text":
            ...
            context.save();
            context.translate(options.padding, options.padding);
            canvg__default['default'](canvas, text, Object.assign({}, canvgOptions, {
              offsetX: layer.x,
              offsetY: layer.y
            }));
            context.restore();
          ...
          case "svg":
            ...
            context.rect(0, 0, clip.width, clip.height);
            context.clip();
            canvg__default['default'](canvas, outer, Object.assign({}, canvgOptions, {
  ...
  */
  ...
  function saveElement(elem) {
    ...
    if (!(elem instanceof Array) && options.type === "svg") {
      ...
      d3Selection.select(clone).call(svgPresets);
      d3Selection.select(clone).selectAll("*").each(function () {
        d3Selection.select(this).call(svgPresets);
      });
