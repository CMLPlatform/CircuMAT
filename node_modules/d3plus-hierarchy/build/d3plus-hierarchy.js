...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-shape'), require('d3plus-common'), require('d3plus-shape'), require('d3plus-viz'), require('d3-collection'), require('d3-hierarchy'), require('d3-scale'), require('d3plus-format')) : typeof define === 'function' && define.amd ? define('d3plus-hierarchy', ['exports', 'd3-array', 'd3-shape', 'd3plus-common', 'd3plus-shape', 'd3plus-viz', 'd3-collection', 'd3-hierarchy', 'd3-scale', 'd3plus-format'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Shape, global.d3plusCommon, global.d3plusShape, global.d3plusViz, global.d3Collection, global.d3Hierarchy, global.d3Scale, global.d3plusFormat));
})(this, function (exports, d3Array, d3Shape, d3plusCommon, d3plusShape, d3plusViz, d3Collection, d3Hierarchy, d3Scale, d3plusFormat) {
  'use strict';
  /**
      @class Pie
      @extends Viz
  ...
  */
  ...
  var Pie = /*#__PURE__*/function (_d3plusViz$Viz) {
    _inherits(Pie, _d3plusViz$Viz);
  ...
  */
  ...
  var Donut = /*#__PURE__*/function (_Pie) {
    ...
    var _super2 = _createSuper(Donut);
    ...
    */
    function Donut() {
      ...
      _this3._innerRadius = function () {
        return d3Array.min([_this3._width - _this3._margin.left - _this3._margin.right, _this3._height - _this3._margin.top - _this3._margin.bottom]) / 4;
      };
  ...
  */
  ...
  var Pack = /*#__PURE__*/function (_d3plusViz$Viz2) {
    _inherits(Pack, _d3plusViz$Viz2);

    var _super3 = _createSuper(Pack);
    ...
    */
    function Pack() {
      ...
      _this4._layoutPadding = 1;
      var defaultLegend = _this4._legend;

      _this4._legend = function (config, arr) {
        if (arr.length === _this4._filteredData.length) return false;
        return defaultLegend.bind(_assertThisInitialized(_this4))(config, arr);
      };

      _this4._on.mouseenter = function () {};

      var defaultMouseMoveLegend = _this4._on["mousemove.legend"];

      _this4._on["mousemove.legend"] = function (d, i, x, event) {
        defaultMouseMoveLegend(d, i, x, event);

        var ids = _this4._ids(d, i);

        var hoverData = recursionCircles(d);

        _this4.hover(function (h) {
      ...
      var defaultMouseMoveShape = _this4._on["mousemove.shape"];
      ...
      _this4._pack = d3Hierarchy.pack();
      _this4._packOpacity = d3plusCommon.constant(0.25);
      ...
      _this4._sort = function (a, b) {
        return b.value - a.value;
      };

      _this4._sum = d3plusCommon.accessor("value");
      return _this4;
    }
    /**
        Extends the draw behavior of the abstract Viz class.
    ...
    _createClass(Pack, [{
      ...
      value: function _draw(callback) {
        ...
        packData.forEach(function (d, i) {
          ...
          d.data.__d3plusOpacity__ = d.height ? _this5._packOpacity(d.data, i) : 1;
  ...
  */
  ...
  var Tree = /*#__PURE__*/function (_d3plusViz$Viz3) {
    _inherits(Tree, _d3plusViz$Viz3);

    var _super4 = _createSuper(Tree);
    ...
    */
    function Tree() {
      ...
      _this6._orient = "vertical";

      _this6._separation = function (a, b) {
        return a.parent === b.parent ? 1 : 2;
      };

      _this6._shape = d3plusCommon.constant("Circle");
      _this6._shapeConfig = d3plusCommon.assign(_this6._shapeConfig, {
        ariaLabel: function ariaLabel(d, i) {
          return _this6._treeData ? "".concat(_this6._treeData[i].depth, ". ").concat(_this6._drawLabel(d, i), ".") : "";
        },
        labelConfig: {
          fontColor: "#444"
        },
    ...
    _createClass(Tree, [{
      ...
      value: function _draw(callback) {
        ...
        var treeData = this._treeData = this._tree.separation(this._separation).size([width, height])(d3Hierarchy.hierarchy({
          ...
          return d.depth <= _this7._groupBy.length && d.parent;
        });
        /**
        ...
        */
        ...
        this._labelWidths = nest(treeData, function (d) {
          ...
          return d.values.reduce(function (num, v, i) {
            var next = i < d.values.length - 1 ? d.values[i + 1].x : width + _this7._margin[left],
                prev = i ? d.values[i - 1].x : _this7._margin[left];
        ...
        this._shapes.push(new d3plusShape.Path().data(treeData.filter(function (d) {
          ...
          d: function d(_d) {
            var r = _this7._shapeConfig.r;
            if (typeof r === "function") r = r(_d.data, _d.i);
            var px = _d.parent.x - _d.x + (_this7._orient === "vertical" ? 0 : r),
                py = _d.parent.y - _d.y + (_this7._orient === "vertical" ? r : 0),
                x = _this7._orient === "vertical" ? 0 : -r,
                y = _this7._orient === "vertical" ? -r : 0;
            return _this7._orient === "vertical" ? "M".concat(x, ",").concat(y, "C").concat(x, ",").concat((y + py) / 2, " ").concat(px, ",").concat((y + py) / 2, " ").concat(px, ",").concat(py) : "M".concat(x, ",").concat(y, "C").concat((x + px) / 2, ",").concat(y, " ").concat((x + px) / 2, ",").concat(py, " ").concat(px, ",").concat(py);
          },
          id: function id(d, i) {
            return _this7._ids(d, i).join("-");
          }
        }).render());
        ...
        this._shapes.push(new d3plusShape.Circle().data(treeData).select(d3plusCommon.elem("g.d3plus-Tree-Shapes", elemObject).node()).config(d3plusCommon.configPrep.bind(this)(this._shapeConfig, "shape", "Circle")).config({
          ...
          label: function label(d, i) {
            if (_this7._label) return _this7._label(d.data, i);

            var ids = _this7._ids(d, i).slice(0, d.depth);

            return ids[ids.length - 1];
          },
          labelConfig: {
            textAnchor: function textAnchor(d) {
              return _this7._orient === "vertical" ? "middle" : d.data.children && d.data.depth !== _this7._groupBy.length ? "end" : "start";
            },
            verticalAlign: function verticalAlign(d) {
              return _this7._orient === "vertical" ? d.data.depth === 1 ? "bottom" : "top" : "middle";
            }
          },
          hitArea: function hitArea(d, i, s) {
            var h = _this7._labelHeight,
                w = _this7._labelWidths[d.depth - 1];
            return {
              width: _this7._orient === "vertical" ? w : s.r * 2 + w,
              height: _this7._orient === "horizontal" ? h : s.r * 2 + h,
              x: _this7._orient === "vertical" ? -w / 2 : d.children && d.depth !== _this7._groupBy.length ? -(s.r + w) : -s.r,
              y: _this7._orient === "horizontal" ? -h / 2 : d.children && d.depth !== _this7._groupBy.length ? -(s.r + _this7._labelHeight) : -s.r
            };
          },
          labelBounds: function labelBounds(d, i, s) {
            ...
            var h = _this7._labelHeight,
                height = _this7._orient === "vertical" ? "height" : "width",
                w = _this7._labelWidths[d.depth - 1],
                width = _this7._orient === "vertical" ? "width" : "height",
                x = _this7._orient === "vertical" ? "x" : "y",
                y = _this7._orient === "vertical" ? "y" : "x";
            return _ref = {}, _defineProperty(_ref, width, w), _defineProperty(_ref, height, h), _defineProperty(_ref, x, -w / 2), _defineProperty(_ref, y, d.children && d.depth !== _this7._groupBy.length ? -(s.r + h) : s.r), _ref;
          }
        }).render());
  ...
  */
  ...
  var Treemap = /*#__PURE__*/function (_d3plusViz$Viz4) {
    ...
    var _super5 = _createSuper(Treemap);
    ...
    */
    function Treemap() {
      ...
      _this8._legendSort = function (a, b) {
        return _this8._sum(b) - _this8._sum(a);
      };

      _this8._legendTooltip = d3plusCommon.assign({}, _this8._legendTooltip, {
        tbody: []
      });
      _this8._shapeConfig = d3plusCommon.assign({}, _this8._shapeConfig, {
        ariaLabel: function ariaLabel(d, i) {
          var rank = _this8._rankData ? "".concat(_this8._rankData.indexOf(d) + 1, ". ") : "";
          return "".concat(rank).concat(_this8._drawLabel(d, i), ", ").concat(_this8._sum(d, i), ".");
        },
        labelConfig: {
          fontMax: 40,
          fontMin: 8,
      ...
      _this8._sum = d3plusCommon.accessor("value");
      _this8._thresholdKey = _this8._sum;
      _this8._tile = d3Hierarchy.treemapSquarify;
      _this8._tooltipConfig = d3plusCommon.assign({}, _this8._tooltipConfig, {
        tbody: [[function () {
          return _this8._translate("Share");
        }, function (d, i, x) {
          return "".concat(d3plusFormat.formatAbbreviate(x.share * 100, _this8._locale), "%");
        }]]
      });
      _this8._treemap = d3Hierarchy.treemap().round(true);
      ...
      value: function _draw(callback) {
        ...
        */
        ...
        function extractLayout(children) {
          for (var _i = 0; _i < children.length; _i++) {
            ...
            if (node.depth <= that._drawDepth) extractLayout(node.children);else {
              ...
              node.data = d3plusCommon.merge(node.data.values, that._aggs);
        ...
        shapeData.forEach(function (d) {
          d.share = _this9._sum(d.data, d.i) / total;
        });
        ...
        this._shapes.push(new d3plusShape.Rect().data(shapeData).label(function (d) {
          return [_this9._drawLabel(d.data, d.i), "".concat(d3plusFormat.formatAbbreviate(d.share * 100, _this9._locale), "%")];
