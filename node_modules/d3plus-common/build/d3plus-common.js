...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('windows-locale'), require('iso639-codes'), require('d3-selection'), require('d3-transition'), require('d3-array'), require('d3-collection')) : typeof define === 'function' && define.amd ? define('d3plus-common', ['exports', 'windows-locale', 'iso639-codes', 'd3-selection', 'd3-transition', 'd3-array', 'd3-collection'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.lcid, global.iso, global.d3Selection, global.d3Transition, global.d3Array, global.d3Collection));
})(this, function (exports, lcid, iso, d3Selection, d3Transition, d3Array, d3Collection) {
  'use strict';
  ...
  var lcid__default = /*#__PURE__*/_interopDefaultLegacy(lcid);
  ...
  */
  ...
  var locales = [];
  var isoKeys = Object.keys(iso__default['default']);
  Object.keys(lcid__default['default']).map(function (id) {
    var locale = lcid__default['default'][id];
    ...
    if (locale.location && isoLanguage) {
      ...
      locales.push((_locales$push = {}, _defineProperty(_locales$push, "name", locale.language), _defineProperty(_locales$push, "location", locale.location), _defineProperty(_locales$push, "tag", locale.tag), _defineProperty(_locales$push, "lcid", locale.id), _defineProperty(_locales$push, "iso639-2", iso__default['default'][isoLanguage]["iso639-2"]), _defineProperty(_locales$push, "iso639-1", iso__default['default'][isoLanguage]["iso639-1"]), _locales$push));
    }
  });
  var defaultLocales = {
    ar: "ar-SA",
