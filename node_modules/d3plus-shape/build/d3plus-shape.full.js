...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define('d3plus-shape', ['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}));
})(this, function (exports) {
  var _marked = /*#__PURE__*/regeneratorRuntime.mark(selection_iterator),
      _marked2 = /*#__PURE__*/regeneratorRuntime.mark(numbers),
      _marked3 = /*#__PURE__*/regeneratorRuntime.mark(flatten);
  ...
  */
  ...
  function numbers(values, valueof) {
    var _iterator2, _step2, value, index, _iterator3, _step3, _value;
  ...
  function quickselect(array, k) {
    ...
    while (right > left) {
      if (right - left > 600) {
        ...
        var _s = 0.5 * Math.exp(2 * z / 3);

        var _sd = 0.5 * Math.sqrt(z * _s * (n - _s) / n) * (m - n / 2 < 0 ? -1 : 1);

        var newLeft = Math.max(left, Math.floor(k - m * _s / n + _sd));
        var newRight = Math.min(right, Math.floor(k + (n - m) * _s / n + _sd));
  ...
  function flatten(arrays) {
    var _iterator10, _step10, _array;

    return regeneratorRuntime.wrap(function flatten$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _iterator10 = _createForOfIteratorHelper(arrays);
            _context3.prev = 1;
          ...
          case 3:
            ...
            _array = _step10.value;
            return _context3.delegateYield(_array, "t0", 6);
    ...
    _createClass2(Image, [{
      ...
      value: function render(callback) {
        ...
        var enter = images.enter().append("image").attr("class", "d3plus-Image").attr("opacity", 0).attr("width", 0).attr("height", 0).attr("x", function (d, i) {
          return _this3._x(d, i) + _this3._width(d, i) / 2;
        }).attr("y", function (d, i) {
          return _this3._y(d, i) + _this3._height(d, i) / 2;
        });
        ...
        update.attr("xlink:href", this._url).style("pointer-events", this._pointerEvents).transition(t).attr("opacity", this._opacity).attr("width", function (d, i) {
          return _this3._width(d, i);
        }).attr("height", function (d, i) {
          return _this3._height(d, i);
        }).attr("x", function (d, i) {
          return _this3._x(d, i);
        }).attr("y", function (d, i) {
          return _this3._y(d, i);
        }).each(function (d, i) {
  ...
  var TextBox = /*#__PURE__*/function (_BaseClass) {
    ...
    */
    ...
    function TextBox() {
      ...
      _classCallCheck$1(this, TextBox);
  ...
  */
  ...
  var Shape = /*#__PURE__*/function (_BaseClass2) {
    "use strict";

    _inherits2(Shape, _BaseClass2);

    var _super2 = _createSuper2(Shape);
    ...
    */
    function Shape() {
      ...
      _this4._activeOpacity = 0.25;
      _this4._activeStyle = {
        "stroke": function stroke(d, i) {
          var c = _this4._fill(d, i);

          if (["transparent", "none"].includes(c)) c = _this4._stroke(d, i);
          return color(c).darker(1);
        },
        "stroke-width": function strokeWidth(d, i) {
          var s = _this4._strokeWidth(d, i) || 1;
          return s * 3;
        }
      };
      _this4._ariaLabel = constant$2("");
      _this4._backgroundImage = constant$2(false);
      _this4._backgroundImageClass = new Image();
      _this4._data = [];
      _this4._duration = 600;
      _this4._fill = constant$2("black");
      _this4._fillOpacity = constant$2(1);
      _this4._hoverOpacity = 0.5;
      _this4._hoverStyle = {
        "stroke": function stroke(d, i) {
          var c = _this4._fill(d, i);
      ...
      _this4._id = function (d, i) {
        return d.id !== void 0 ? d.id : i;
      };

      _this4._label = constant$2(false);
      _this4._labelClass = new TextBox();
      _this4._labelConfig = {
        fontColor: function fontColor(d, i) {
          return colorContrast(_this4._fill(d, i));
        },
        fontSize: 12,
        padding: 5
      };
      _this4._name = "Shape";
      _this4._opacity = constant$2(1);
      _this4._pointerEvents = constant$2("visiblePainted");
      _this4._role = constant$2("presentation");
      _this4._rotate = constant$2(0);
      _this4._rx = constant$2(0);
      _this4._ry = constant$2(0);
      _this4._scale = constant$2(1);
      _this4._shapeRendering = constant$2("geometricPrecision");

      _this4._stroke = function (d, i) {
        return color(_this4._fill(d, i)).darker(1);
      };

      _this4._strokeDasharray = constant$2("0");
      _this4._strokeLinecap = constant$2("butt");
      _this4._strokeOpacity = constant$2(1);
      _this4._strokeWidth = constant$2(0);
      _this4._tagName = tagName;
      _this4._textAnchor = constant$2("start");
      _this4._vectorEffect = constant$2("non-scaling-stroke");
      _this4._verticalAlign = constant$2("top");
      _this4._x = accessor("x", 0);
      _this4._y = accessor("y", 0);
      return _this4;
    }
    /**
        @memberof Shape
      ...
      value: function _applyEvents(handler) {
        ...
        var _loop2 = function _loop2(e) {
          handler.on(events[e], function (event, d, i) {
            if (!_this5._on[events[e]]) return;
            if (d.i !== void 0) i = d.i;

            if (d.nested && d.values) {
              var calcPoint = function calcPoint(d, i) {
                if (_this5._discrete === "x") return [_this5._x(d, i), cursor[1]];else if (_this5._discrete === "y") return [cursor[0], _this5._y(d, i)];else return [_this5._x(d, i), _this5._y(d, i)];
              };

              var cursor = pointer(event, _this5._select.node()),
      ...
      */
      ...
      value: function _applyTransform(elem) {
        ...
        elem.attr("transform", function (d, i) {
          return "\n        translate(".concat(d.__d3plusShape__ ? d.translate ? d.translate : "".concat(_this6._x(d.data, d.i), ",").concat(_this6._y(d.data, d.i)) : "".concat(_this6._x(d, i), ",").concat(_this6._y(d, i)), ")\n        scale(").concat(d.__d3plusShape__ ? d.scale || _this6._scale(d.data, d.i) : _this6._scale(d, i), ")\n        rotate(").concat(d.__d3plusShape__ ? d.rotate ? d.rotate : _this6._rotate(d.data || d, d.i) : _this6._rotate(d.data || d, d.i), ")");
        });
      }
      /**
          @memberof Shape
      ...
      value: function _renderImage() {
        ...
        this._update.merge(this._enter).data().forEach(function (datum, i) {
          ...
          if (aes.r || aes.width && aes.height) {
            ...
            var _height = aes.r ? aes.r * 2 : aes.height,
                url = _this7._backgroundImage(d, i),
                width = aes.r ? aes.r * 2 : aes.width;

            if (url) {
              var _x = d.__d3plusShape__ ? d.translate ? d.translate[0] : _this7._x(d.data, d.i) : _this7._x(d, i),
                  _y = d.__d3plusShape__ ? d.translate ? d.translate[1] : _this7._y(d.data, d.i) : _this7._y(d, i);
      ...
      */
      ...
      value: function _renderLabels() {
        ...
        this._update.merge(this._enter).data().forEach(function (datum, i) {
          ...
          if (datum.nested && datum.key && datum.values) {
            d = datum.values[0];
            i = _this8._data.indexOf(d);
          }

          var labels = _this8._label(d, i);

          if (_this8._labelBounds && labels !== false && labels !== undefined && labels !== null) {
            var bounds = _this8._labelBounds.bind(_this8)(d, i, _this8._aes(datum, i));

            if (bounds) {
              if (labels.constructor !== Array) labels = [labels];

              var _x2 = d.__d3plusShape__ ? d.translate ? d.translate[0] : _this8._x(d.data, d.i) : _this8._x(d, i),
                  _y2 = d.__d3plusShape__ ? d.translate ? d.translate[1] : _this8._y(d.data, d.i) : _this8._y(d, i);
              ...
              for (var l = 0; l < labels.length; l++) {
                var _b = bounds.constructor === Array ? bounds[l] : Object.assign({}, bounds);

                var rotate = _this8._rotate(d, i);

                var r = d.labelConfig && d.labelConfig.rotate ? d.labelConfig.rotate : bounds.angle !== undefined ? bounds.angle : 0;
                r += rotate;
                var rotateAnchor = rotate !== 0 ? [_b.x * -1 || 0, _b.y * -1 || 0] : [_b.width / 2, _b.height / 2];
                labelData.push({
                  __d3plus__: true,
                  data: d,
                  height: _b.height,
                  l: l,
                  id: "".concat(_this8._id(d, i), "_").concat(l),
                  r: r,
      ...
      */
      ...
      value: function render(callback) {
        ...
        var enter = this._enter = update.enter().append(this._tagName).attr("class", function (d, i) {
          return "d3plus-Shape d3plus-".concat(_this9._name, " d3plus-id-").concat(strip(_this9._nestWrapper(_this9._id)(d, i)));
        ...
        var hitEnter = hitAreas.enter().append(isLine ? "path" : "rect").attr("class", function (d, i) {
          return "d3plus-HitArea d3plus-id-".concat(strip(_this9._nestWrapper(_this9._id)(d, i)));
        ...
        setTimeout(function () {
          if (_this9._active) _this9._renderActive();else if (_this9._hover) _this9._renderHover();
    ...
    return function pathCommandInterpolator(t) {
      ...
      if (t > 0) {
        for (var i = 0; i < interpolatedCommands.length; ++i) {
          ...
          var _iterator15 = _createForOfIteratorHelper(typeMap[interpolatedCommand.type]),
              _step15;
  ...
  function interpolatePath(a, b, excludeSegment) {
    ...
    return function pathStringInterpolator(t) {
      ...
      var _iterator16 = _createForOfIteratorHelper(interpolatedCommands),
          _step16;

      try {
        for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
          var interpolatedCommand = _step16.value;
  ...
  */
  ...
  function polygonRayCast(poly, origin) {
    ...
    while (++i < n) {
      var _a2 = b;
      b = poly[i];
      var p = lineIntersection(origin, shiftedOrigin, _a2, b);

      if (p && segmentBoxContains(_a2, b, p)) {
    ...
    for (var ai = 0; ai < angles.length; ai++) {
      ...
      for (var i = 0; i < origins.length; i++) {
        ...
        for (var _i2 = 0; _i2 < modifOrigins.length; _i2++) {
          ...
          for (var _a3 = 0; _a3 < aRatios.length; _a3++) {
            var aRatio = aRatios[_a3]; // do a binary search to find the max width that works
            ...
            while (right - left >= widthStep) {
              ...
              var _height2 = width / aRatio;

              var _origin3 = _slicedToArray(origin, 2),
                  cx = _origin3[0],
                  _cy = _origin3[1];

              var rectPoly = [[cx - width / 2, _cy - _height2 / 2], [cx + width / 2, _cy - _height2 / 2], [cx + width / 2, _cy + _height2 / 2], [cx - width / 2, _cy + _height2 / 2]];
              rectPoly = polygonRotate(rectPoly, angleRad, origin);
              var insidePoly = polygonInside(rectPoly, poly);

              if (insidePoly) {
                // we know that the area is already greater than the maxArea found so far
                maxArea = width * _height2;
              ...
              if (options.events) events.push({
                type: "rectangle",
                areaFraction: width * _height2 / area,
                cx: cx,
                cy: _cy,
                width: width,
                height: _height2,
  ...
  */
  ...
  var Area = /*#__PURE__*/function (_Shape) {
    ...
    _inherits2(Area, _Shape);

    var _super3 = _createSuper2(Area);
    ...
    */
    function Area() {
      ...
      _classCallCheck2(this, Area);

      _this10 = _super3.call(this);
      _this10._curve = constant$2("linear");

      _this10._defined = function () {
        return true;
      };

      _this10._labelBounds = function (d, i, aes) {
        ...
        return {
          ...
          width: r.width,
          height: r.height,
          x: r.cx - r.width / 2 - _this10._x(d, i),
          y: r.cy - r.height / 2 - _this10._y(d, i)
        };
      };

      _this10._labelConfig = Object.assign(_this10._labelConfig, {
        textAnchor: "middle",
        verticalAlign: "middle"
      });
      _this10._name = "Area";
      _this10._x = accessor("x");
      _this10._x0 = accessor("x");
      _this10._x1 = null;
      _this10._y = constant$2(0);
      _this10._y0 = constant$2(0);
      _this10._y1 = accessor("y");
      return _this10;
    }
    /**
        @memberof Area
    ...
    _createClass2(Area, [{
      ...
      value: function _aes(d) {
        ...
        var values = d.values.slice().sort(function (a, b) {
          return _this11._y1 ? _this11._x(a) - _this11._x(b) : _this11._y(a) - _this11._y(b);
        });
        var points1 = values.map(function (v, z) {
          return [_this11._x0(v, z), _this11._y0(v, z)];
        });
        var points2 = values.reverse().map(function (v, z) {
          return _this11._y1 ? [_this11._x(v, z), _this11._y1(v, z)] : [_this11._x1(v, z), _this11._y(v, z)];
        });
      ...
      */
      ...
      value: function _dataFilter(data) {
        ...
        var areas = nest().key(this._id).entries(data).map(function (d) {
          ...
          var x = extent(d.values.map(_this12._x).concat(d.values.map(_this12._x0)).concat(_this12._x1 ? d.values.map(_this12._x1) : []));
          d.xR = x;
          d.width = x[1] - x[0];
          d.x = x[0] + d.width / 2;
          var y = extent(d.values.map(_this12._y).concat(d.values.map(_this12._y0)).concat(_this12._y1 ? d.values.map(_this12._y1) : []));
          d.yR = y;
          d.height = y[1] - y[0];
          d.y = y[0] + d.height / 2;
          d.nested = true;
      ...
      */
      ...
      value: function render(callback) {
        ...
        _get(_getPrototypeOf2(Area.prototype), "render", this).call(this, callback);
        ...
        var exitPath = area().defined(function (d) {
          ...
          return _this13._x1 ? _this13._x0(d, i) + (_this13._x1(d, i) - _this13._x0(d, i)) / 2 : _this13._x0(d, i);
        }).x1(function (d, i) {
          return _this13._x1 ? _this13._x0(d, i) + (_this13._x1(d, i) - _this13._x0(d, i)) / 2 : _this13._x0(d, i);
        }).y0(function (d, i) {
          return _this13._y1 ? _this13._y0(d, i) + (_this13._y1(d, i) - _this13._y0(d, i)) / 2 : _this13._y0(d, i);
        }).y1(function (d, i) {
          return _this13._y1 ? _this13._y0(d, i) + (_this13._y1(d, i) - _this13._y0(d, i)) / 2 : _this13._y0(d, i);
        });
  ...
  */
  ...
  var Bar = /*#__PURE__*/function (_Shape2) {
    ...
    _inherits2(Bar, _Shape2);

    var _super4 = _createSuper2(Bar);
    ...
    */
    function Bar() {
      ...
      _classCallCheck2(this, Bar);

      _this14 = _super4.call(this, "rect");
      _this14._name = "Bar";
      _this14._height = constant$2(10);

      _this14._labelBounds = function (d, i, s) {
        return {
          width: s.width,
          height: s.height,
          x: _this14._x1 !== null ? _this14._getX(d, i) : -s.width / 2,
          y: _this14._x1 === null ? _this14._getY(d, i) : -s.height / 2
        };
      };

      _this14._width = constant$2(10);
      _this14._x = accessor("x");
      _this14._x0 = accessor("x");
      _this14._x1 = null;
      _this14._y = constant$2(0);
      _this14._y0 = constant$2(0);
      _this14._y1 = accessor("y");
      return _this14;
    }
    /**
        @memberof Bar
    ...
    */
    ...
    _createClass2(Bar, [{
      ...
      value: function render(callback) {
        ...
        _get(_getPrototypeOf2(Bar.prototype), "render", this).call(this, callback);

        var enter = this._enter.attr("width", function (d, i) {
          return _this15._x1 === null ? _this15._getWidth(d, i) : 0;
        }).attr("height", function (d, i) {
          return _this15._x1 !== null ? _this15._getHeight(d, i) : 0;
        }).attr("x", function (d, i) {
          return _this15._x1 === null ? -_this15._getWidth(d, i) / 2 : 0;
        }).attr("y", function (d, i) {
          return _this15._x1 !== null ? -_this15._getHeight(d, i) / 2 : 0;
        }).call(this._applyStyle.bind(this));
      ...
      */
      ...
      value: function _applyPosition(elem) {
        ...
        elem.attr("width", function (d, i) {
          return _this16._getWidth(d, i);
        }).attr("height", function (d, i) {
          return _this16._getHeight(d, i);
        }).attr("x", function (d, i) {
          return _this16._x1 !== null ? _this16._getX(d, i) : -_this16._getWidth(d, i) / 2;
        }).attr("y", function (d, i) {
          return _this16._x1 === null ? _this16._getY(d, i) : -_this16._getHeight(d, i) / 2;
        });
      }
      /**
          @memberof Bar
  ...
  */
  ...
  var Circle = /*#__PURE__*/function (_Shape3) {
    ...
    _inherits2(Circle, _Shape3);

    var _super5 = _createSuper2(Circle);
    ...
    */
    function Circle() {
      ...
      _this17 = _super5.call(this, "circle");
      ...
      _this17._labelConfig = assign(_this17._labelConfig, {
        textAnchor: "middle",
        verticalAlign: "middle"
      });
      _this17._name = "Circle";
      _this17._r = accessor("r");
      return _this17;
    }
    /**
        @memberof Circle
    ...
    _createClass2(Circle, [{
      ...
      value: function _applyPosition(elem) {
        ...
        elem.attr("r", function (d, i) {
          return _this18._r(d, i);
        }).attr("x", function (d, i) {
          return -_this18._r(d, i) / 2;
        }).attr("y", function (d, i) {
          return -_this18._r(d, i) / 2;
        });
      }
      ...
      */
      ...
      key: "render",
      value: function render(callback) {
        _get(_getPrototypeOf2(Circle.prototype), "render", this).call(this, callback);
  ...
  */
  ...
  var Rect = /*#__PURE__*/function (_Shape4) {
    ...
    _inherits2(Rect, _Shape4);

    var _super6 = _createSuper2(Rect);
    ...
    */
    function Rect() {
      ...
      _classCallCheck2(this, Rect);

      _this19 = _super6.call(this, "rect");
      _this19._height = accessor("height");

      _this19._labelBounds = function (d, i, s) {
        return {
          width: s.width,
          height: s.height,
          x: -s.width / 2,
    ...
    */
    ...
    _createClass2(Rect, [{
      key: "render",
      value: function render(callback) {
        _get(_getPrototypeOf2(Rect.prototype), "render", this).call(this, callback);
      ...
      */
      ...
      value: function _applyPosition(elem) {
        ...
        elem.attr("width", function (d, i) {
          return _this20._width(d, i);
        }).attr("height", function (d, i) {
          return _this20._height(d, i);
        }).attr("x", function (d, i) {
          return -_this20._width(d, i) / 2;
        }).attr("y", function (d, i) {
          return -_this20._height(d, i) / 2;
        });
      }
      /**
          @memberof Rect
  ...
  */
  ...
  var Line = /*#__PURE__*/function (_Shape5) {
    ...
    _inherits2(Line, _Shape5);

    var _super7 = _createSuper2(Line);
    ...
    */
    function Line() {
      ...
      _this21._curve = constant$2("linear");

      _this21._defined = function (d) {
        return d;
      };

      _this21._fill = constant$2("none");
      _this21._hitArea = constant$2({
        "d": function d(_d2) {
          return _this21._path(_d2.values);
        },
        "fill": "none",
        "stroke-width": 10,
        "transform": null
      ...
      _this21._name = "Line";
      _this21._path = line();
      _this21._stroke = constant$2("black");
      _this21._strokeWidth = constant$2(1);
      return _this21;
    }
    /**
        @memberof Line
    ...
    _createClass2(Line, [{
      ...
      value: function _dataFilter(data) {
        ...
        var lines = nest().key(this._id).entries(data).map(function (d) {
          d.data = objectMerge(d.values);
          d.i = data.indexOf(d.values[0]);
          var x = extent(d.values, _this22._x);
          d.xR = x;
          d.width = x[1] - x[0];
          d.x = x[0] + d.width / 2;
          var y = extent(d.values, _this22._y);
          d.yR = y;
          d.height = y[1] - y[0];
          d.y = y[0] + d.height / 2;
          d.nested = true;
      ...
      */
      ...
      value: function render(callback) {
        ...
        _get(_getPrototypeOf2(Line.prototype), "render", this).call(this, callback);
      ...
      value: function _aes(d, i) {
        ...
        return {
          points: d.values.map(function (p) {
            return [_this24._x(p, i), _this24._y(p, i)];
          })
        };
      }
      /**
  ...
  */
  ...
  var Whisker = /*#__PURE__*/function (_BaseClass3) {
    "use strict";

    _inherits2(Whisker, _BaseClass3);

    var _super8 = _createSuper2(Whisker);
    ...
    */
    function Whisker() {
      ...
      _classCallCheck2(this, Whisker);

      _this25 = _super8.call(this);
      _this25._endpoint = accessor("endpoint", "Rect");
      _this25._endpointConfig = {
        Circle: {
          r: accessor("r", 5)
        }
      };
      _this25._length = accessor("length", 25);
      _this25._lineConfig = {};
      _this25._orient = accessor("orient", "top");
      _this25._x = accessor("x", 0);
      _this25._y = accessor("y", 0);
      return _this25;
    }
    /**
        @memberof Whisker
    ...
    _createClass2(Whisker, [{
      ...
      value: function render(callback) {
        ...
        this._data.forEach(function (d, i) {
          var orient = _this26._orient(d, i);

          var x = _this26._x(d, i);

          var y = _this26._y(d, i);

          var endpointX = x;
          if (orient === "left") endpointX -= _this26._length(d, i);else if (orient === "right") endpointX += _this26._length(d, i);
          var endpointY = y;
          if (orient === "top") endpointY -= _this26._length(d, i);else if (orient === "bottom") endpointY += _this26._length(d, i);
          lineData.push({
            __d3plus__: true,
            data: d,
            i: i,
        ...
        var whiskerData = this._data.map(function (d, i) {
          ...
          dataObj.data = d;
          dataObj.i = i;
          dataObj.endpoint = _this26._endpoint(d, i);
          dataObj.length = _this26._length(d, i);
          dataObj.orient = _this26._orient(d, i);

          var endpointX = _this26._x(d, i);

          if (dataObj.orient === "left") endpointX -= dataObj.length;else if (dataObj.orient === "right") endpointX += dataObj.length;

          var endpointY = _this26._y(d, i);
        ...
        nest().key(function (d) {
          ...
          _this26._whiskerEndpoint.push(new shapes[shapeName]().data(shapeData.values).select(elem("g.d3plus-Whisker-Endpoint-".concat(shapeName), {
          ...
          }).config(configPrep.bind(_this26)(_this26._endpointConfig, "shape", shapeName)).render());
        });
        return this;
      }
      /**
  ...
  */
  ...
  var Box = /*#__PURE__*/function (_BaseClass4) {
    "use strict";

    _inherits2(Box, _BaseClass4);

    var _super9 = _createSuper2(Box);
    ...
    */
    function Box() {
      ...
      _classCallCheck2(this, Box);

      _this27 = _super9.call(this);
      _this27._medianConfig = {
        fill: constant$2("black")
      };
      _this27._orient = accessor("orient", "vertical");
      _this27._outlier = accessor("outlier", "Circle");
      _this27._outlierConfig = {
        Circle: {
          r: accessor("r", 5)
        },
        Rect: {
          height: function height(d, i) {
            return _this27._orient(d, i) === "vertical" ? 5 : 20;
          },
          width: function width(d, i) {
            return _this27._orient(d, i) === "vertical" ? 20 : 5;
          }
        }
      };
      _this27._rectConfig = {
      ...
      _this27._rectWidth = constant$2(50);
      _this27._whiskerConfig = {};
      _this27._whiskerMode = ["tukey", "tukey"];
      _this27._x = accessor("x", 250);
      _this27._y = accessor("y", 250);
      return _this27;
    }
    /**
        @memberof Box
    ...
    _createClass2(Box, [{
      ...
      value: function render() {
        ...
        var filteredData = nest().key(function (d, i) {
          return _this28._orient(d, i) === "vertical" ? _this28._x(d, i) : _this28._y(d, i);
        }).entries(this._data).map(function (d) {
          d.data = objectMerge(d.values);
          d.i = _this28._data.indexOf(d.values[0]);
          d.orient = _this28._orient(d.data, d.i);
          var values = d.values.map(d.orient === "vertical" ? _this28._y : _this28._x);
          ...
          if (d.orient === "vertical") {
            d.height = rectLength;
            d.width = _this28._rectWidth(d.data, d.i);
            d.x = _this28._x(d.data, d.i);
            d.y = d.first + rectLength / 2;
          } else if (d.orient === "horizontal") {
            // Compute values for horizontal orientation.
            d.height = _this28._rectWidth(d.data, d.i);
            d.width = rectLength;
            d.x = d.first + rectLength / 2;
            d.y = _this28._y(d.data, d.i);
          } // Compute data for outliers.


          d.values.forEach(function (eachValue, index) {
            var value = d.orient === "vertical" ? _this28._y(eachValue, index) : _this28._x(eachValue, index);
            ...
            if (value < d.lowerLimit || value > d.upperLimit) {
              ...
              dataObj.i = index;
              dataObj.outlier = _this28._outlier(eachValue, index);
        ...
        nest().key(function (d) {
          ...
          _this28._whiskerEndpoint.push(new shapes$1[shapeName]().data(shapeData.values).select(elem("g.d3plus-Box-Outlier-".concat(shapeName), {
            parent: _this28._select
          }).node()).config(configPrep.bind(_this28)(_this28._outlierConfig, "shape", shapeName)).render());
        });
        return this;
      }
      /**
  ...
  var shapeEdgePoint = function shapeEdgePoint(angle, distance) {
    ...
    if (shape === "square") {
      ...
      if (angle < pi$2 / 2) {
        ...
        _x3 += angle < diagonal ? distance : distance / tan;
        _y3 += angle < diagonal ? tan * distance : distance;
      } else if (angle <= pi$2) {
        var _tan = Math.tan(pi$2 - angle);

        _x3 -= angle < pi$2 - diagonal ? distance / _tan : distance;
        _y3 += angle < pi$2 - diagonal ? distance : _tan * distance;
      } else if (angle < diagonal + pi$2) {
        _x3 -= distance;
        _y3 -= Math.tan(angle - pi$2) * distance;
      } else if (angle < 3 * pi$2 / 2) {
        _x3 -= distance / Math.tan(angle - pi$2);
        _y3 -= distance;
      } else if (angle < 2 * pi$2 - diagonal) {
        _x3 += distance / Math.tan(2 * pi$2 - angle);
        _y3 -= distance;
      } else {
        _x3 += distance;
        _y3 -= Math.tan(2 * pi$2 - angle) * distance;
      }
  ...
  var path2polygon = function path2polygon(path) {
    ...
    while (match !== null) {
      if (["M", "L"].includes(match[1])) poly.push(match[2].split(",").map(Number));else if (match[1] === "A") {
        ...
        var _step17 = angle / (angle / (pi$3 * 2) * (radius * pi$3 * 2) / segmentLength);

        var _start = Math.atan2(-prev[1], -prev[0]) - pi$3;

        var i = _step17;

        while (i < angle) {
          poly.push(shapeEdgePoint(points[4] ? _start + i : _start - i, radius));
          i += _step17;
        }
  ...
  */
  ...
  var Path$1 = /*#__PURE__*/function (_Shape6) {
    "use strict";

    _inherits2(Path$1, _Shape6);

    var _super10 = _createSuper2(Path$1);
    ...
    */
    function Path$1() {
      ...
      _classCallCheck2(this, Path$1);

      _this29 = _super10.call(this, "path");
      _this29._d = accessor("path");

      _this29._labelBounds = function (d, i, aes) {
        var r = largestRect(aes.points, {
          angle: _this29._labelConfig.rotate ? _this29._labelConfig.rotate(d, i) : 0
        });
        return r ? {
          angle: r.angle,
          width: r.width,
      ...
      _this29._name = "Path";
      _this29._labelConfig = Object.assign(_this29._labelConfig, {
        textAnchor: "middle",
        verticalAlign: "middle"
      });
      return _this29;
    ...
    */
    ...
    _createClass2(Path$1, [{
      ...
      */
      ...
      key: "render",
      value: function render(callback) {
        _get(_getPrototypeOf2(Path$1.prototype), "render", this).call(this, callback);
