...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-color'), require('d3-zoom'), require('d3-geo'), require('d3-geo-projection'), require('d3-composite-projections'), require('d3-scale'), require('d3-tile'), require('topojson-client'), require('d3plus-common'), require('d3plus-shape'), require('d3plus-viz')) : typeof define === 'function' && define.amd ? define('d3plus-geomap', ['exports', 'd3-array', 'd3-color', 'd3-zoom', 'd3-geo', 'd3-geo-projection', 'd3-composite-projections', 'd3-scale', 'd3-tile', 'topojson-client', 'd3plus-common', 'd3plus-shape', 'd3plus-viz'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Color, global.d3Zoom, global.d3GeoCore, global.d3GeoProjection, global.d3CompositeProjections, global.scales, global.d3Tile, global.topojsonClient, global.d3plusCommon, global.d3plusShape, global.d3plusViz));
})(this, function (exports, d3Array, d3Color, d3Zoom, d3GeoCore, d3GeoProjection, d3CompositeProjections, scales, d3Tile, topojsonClient, d3plusCommon, d3plusShape, d3plusViz) {
  'use strict';
  ...
  var d3GeoCore__namespace = /*#__PURE__*/_interopNamespace(d3GeoCore);

  var d3GeoProjection__namespace = /*#__PURE__*/_interopNamespace(d3GeoProjection);

  var d3CompositeProjections__namespace = /*#__PURE__*/_interopNamespace(d3CompositeProjections);
  ...
  */
  ...
  var d3Geo = Object.assign({}, d3GeoCore__namespace, d3GeoProjection__namespace, d3CompositeProjections__namespace);
  /**
  ...
  */
  ...
  var Geomap = /*#__PURE__*/function (_d3plusViz$Viz) {
    _inherits(Geomap, _d3plusViz$Viz);
    ...
    _createClass(Geomap, [{
      ...
      */
      ...
      value: function _draw(callback) {
        ...
        var r = scales__namespace["scale".concat(this._pointSizeScale.charAt(0).toUpperCase()).concat(this._pointSizeScale.slice(1))]().domain(d3Array.extent(pointData, function (d, i) {
