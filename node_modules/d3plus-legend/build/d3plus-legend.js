...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-selection'), require('d3plus-common'), require('d3plus-color'), require('d3plus-shape'), require('d3plus-text'), require('d3-scale'), require('d3-transition'), require('d3plus-axis'), require('d3plus-format')) : typeof define === 'function' && define.amd ? define('d3plus-legend', ['exports', 'd3-array', 'd3-selection', 'd3plus-common', 'd3plus-color', 'd3plus-shape', 'd3plus-text', 'd3-scale', 'd3-transition', 'd3plus-axis', 'd3plus-format'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Array, global.d3Selection, global.d3plusCommon, global.d3plusColor, global.shapes, global.d3plusText, global.d3Scale, global.d3Transition, global.d3plusAxis, global.d3plusFormat));
})(this, function (exports, d3Array, d3Selection, d3plusCommon, d3plusColor, shapes, d3plusText, d3Scale, d3Transition, d3plusAxis, d3plusFormat) {
  'use strict';
    ...
    */
    function Legend() {
      ...
      _this._shapeConfig = {
        ...
        height: d3plusCommon.constant(12),
        ...
        opacity: 1,
        r: d3plusCommon.constant(6),
        width: d3plusCommon.constant(12),
        x: function x(d, i) {
  ...
  var ColorScale = /*#__PURE__*/function (_d3plusCommon$BaseCla2) {
    ...
    */
    function ColorScale() {
      ...
      _this5._color = ["#54478C", "#2C699A", "#0DB39E", "#83E377", "#EFEA5A"];
      _this5._colorMax = d3plusColor.colorDefaults.on;
      _this5._colorMid = d3plusColor.colorDefaults.light;
      _this5._colorMin = d3plusColor.colorDefaults.off;
      _this5._data = [];
      ...
      _this5._legendConfig = {
        shapeConfig: {
          stroke: d3plusColor.colorDefaults.dark,
          strokeWidth: 1
        }
      };
      _this5._midpoint = 0;
    ...
    */
    ...
    _createClass(ColorScale, [{
      ...
      value: function render(callback) {
        ...
        var domain = this._domain || d3Array.extent(allValues);
